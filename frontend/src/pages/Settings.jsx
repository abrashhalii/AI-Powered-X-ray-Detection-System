...
export default function Settings() {
  ...
  // ML Model
  const [mlSettings, setMlSettings] = useState({ threshold: 0.65, model: 'ResNet50', classes: 'NORMAL,PNEUMONIA', batchSize: 1, enableHeatmap: true, heatmapAlpha: 0.5 });
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: 20, marginTop: 4 }}>
        ...
        <div>
          ...
          {/* About */}
          <div id="about">
            <Section title="ℹ️ About PneumoScan AI" subtitle="System information and version details">
